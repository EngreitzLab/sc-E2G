...
df.gene_exp = mcols(pairs.E2G.Kendall)[,c("TargetGene","mean_log_normalized_rna")]
...
pairs.E2G.ABC$mean_log_normalized_rna = 
  df.gene_exp[pairs.E2G.ABC$TargetGene,"mean_log_normalized_rna"]
